...
def create_table_without_deflection():
    ...
    with col1:
        st.write('### **S.F & B.M Values at Specified Intervals**')
    with col2:
        interval_value = st.number_input('Interval', min_value=0.00, value=1.00, key='b13')
    ...
    if not intervals:
        ...
        if len(sf_values) != len(intervals) or len(bm_values) != len(intervals):
            ...
            st.dataframe(internalforces_values_dataframe, hide_index=True, use_container_width=True)
...
def create_table_with_deflection():
    col1, col2 = st.columns([2, 1], gap='medium', vertical_alignment='center')
    with col1:
        st.write('### **S.F, B.M & Deflection Values at Specified Intervals**')
    with col2:
        interval_value = st.number_input('Interval', min_value=0.00, value=1.00, key='b13')
...
def sfd_bmd_plot():
    ...
    analysis_fig = make_subplots(rows=4, cols=1, shared_xaxes=False, vertical_spacing=0.1,
                                 subplot_titles=(
    ...
    analysis_fig = beam.plot_analytical('sf', color="darkgreen", title="Shear Force Diagram",
    ...
    analysis_fig = beam.plot_analytical('bm', color="blue", title="Bending Moment Diagram",
...
def sfd_bmd_deflection_plot():
    # Create a subplot figure
    analysis_fig = make_subplots(rows=5, cols=1, shared_xaxes=False, vertical_spacing=0.1,
                                 subplot_titles=(
                                     "Beam Schematic", 'Reaction Forces', "Shear Force Diagram",
                                     "Bending Moment Diagram",
                                     "Deflection Diagram"))
    ...
    # Plot shear force diagram in the third row
    analysis_fig = beam.plot_analytical('sf', color="green", title="Shear Force Diagram",
                                        xlabel="Length", ylabel="Shear Force",
                                        xunits=f"{units_dict[unit_systems]['length']}",
                                        yunits=f"{units_dict[unit_systems]['force']}",
                                        fig=analysis_fig, row=3, col=1)
    ...
    analysis_fig = beam.plot_analytical('d', color="red", title="Deflection Diagram",
...
with tab1:
    ...
    # Unit system selectbox
    unit_systems = st.selectbox('Unit system', options=["Metric", 'Imperial'])
    ...
    with st.container(border=True):
        ...
        with col1a:
            ...
            length = st.number_input('Length',
                                     ...
                                     # Replace with your placeholder if needed
    ...
    # INPUTS SECTION
    st.write('### :blue-background[**Construct**]')
    ...
    with col3a:
        ...
        with st.expander('Supports'):
            ...
            col1a, col1b = st.columns([1.5, 2], vertical_alignment='top')
        ...
        with st.expander('Point Loads'):
            ...
            col1a, col1b = st.columns([1.7, 2], vertical_alignment='top')
            ...
            with col1a:
                ...
                pl_location = st.number_input('Location', min_value=0.0, value=None,
        ...
        with st.expander('Point Moments'):
            ...
            with col1a:
                ...
                pm_location = st.number_input('Location', min_value=0.0, value=None,
        ...
        with st.expander('Uniformly Distributed Loads (UDLs)'):
            ...
            with col1a:
                ...
                udl_x1_location = st.number_input('Starting Location', min_value=0, value=None,
                                                  placeholder=units_dict_placeholder[unit_systems]['length'],
                                                  key='udls2')
                udl_x2_location = st.number_input('Ending Location', min_value=0, value=None,
                                                  placeholder=units_dict_placeholder[unit_systems]['length'],
                                                  key='udls3')
        ...
        with st.expander('Variably Distributed Loads (VDLs)'):
            ...
            with col1a:
                ...
                vdl_x1_location = st.number_input('Starting Location', min_value=0, value=None,
                                                  placeholder=units_dict_placeholder[unit_systems]['length'],
                                                  key='vdls3')
                vdl_x2_location = st.number_input('Ending Location', min_value=0, value=None,
                                                  placeholder=units_dict_placeholder[unit_systems]['length'],
                                                  key='vdls4')
    ...
    # ANALYSIS SECTION
    st.write('### :blue-background[**Analysis**]')

    col1a, col1b = st.columns(2, gap='small', vertical_alignment='bottom')
    with col1a:
        analysis_options = st.selectbox('Type of Analysis',
...
with tab2:
    ...
    with col2:
        switch_shape_img = st.toggle('Switch Figure', help='Changes the figure from reference image to created figure based on user inputs')
